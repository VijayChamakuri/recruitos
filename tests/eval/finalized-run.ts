import { err, ok, type Result } from "../../packages/core/src/index.js";
import {
  createRuntimeError,
  readCandidatePacket,
  type RuntimeError
...
import { runClass1EvaluationGate } from "./class1-gate.js";
import type { Class1EvaluationReport, DimensionCoverage } from "./types.js";
...
/** Runs the existing Class 1 gate against associations from a sealed runtime result. */
