...
describe("runtime public API", () => {
  it("exports the audit, connection, command protocol, immutable entity, corpus, role, rubric, evidence, extraction, snapshot, fact, result, run, attempt, read model, composition, use case, schema, persistence pattern, and error foundation", () => {
