...
| Antigravity | c/eval-bench-real-pipeline | Wire tests/eval span-matching and bench suites to real core matching and pipeline exports. | building |
...
- 2026-09-07 Antigravity: swapped readCandidatePacket missing-candidate, missing-head, and missing-result cases to not_found. Preserved persistence_failed for bad input and client/query failures. 100 percent coverage on core and runtime. Opened PR #43.
