...
| Claude Code | b/core-dimension-assessments | T9 part 2, step 3 of 6: dimension assessment derivation in `packages/core/src/pipeline/`. Then hard requirements, routing, and proposals, one PR each. | ready PR |
