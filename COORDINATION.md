...
| Claude Code | b/core-fact-consolidation | T9 part 2, step 2 of 6: multi-document structured fact consolidation in `packages/core/src/pipeline/`. Then dimension assessments, hard requirements, routing, and proposals, one PR each. | ready PR |
