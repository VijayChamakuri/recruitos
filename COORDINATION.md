...
|---|---|---|---|
| Cursor | (none) | chain step 2 merged (#23). Next is candidate_head | idle-ready |
...
- 2026-09-07 Cursor: PR #23 squash-merged to main at 4a2cd1a. Branch cursor/proposal-persistence-3840 deleted. Next is chain step 3, candidate_head.
