  ...
  switch (targetCommand) {
    ...
    case "packet":
      return [
        ...
        "  -h, --help            Show this help message",
        "",
        "The full packet lists current candidate review tasks from the resolution",
        "task read model. A historical --result packet may still show those tasks.",
        "When it does, each task is labeled current_candidate_work so the historical",
        "result is not treated as the owner of live review work.",
        "",
        "Examples:",
    ...
    case "triage:complete-correction":
      return [
        ...
        "to review_required, never resolved. The current packet lists that",
        "outstanding review. Actor is always system:runtime.",
        "",
    ...
    default:
      return [
        ...
        "  packet     Inspect candidate evaluation packet (arithmetic, evidence, tasks)",
